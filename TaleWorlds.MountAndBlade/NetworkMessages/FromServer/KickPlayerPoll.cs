...
// Type: NetworkMessages.FromServer.KickPlayerPoll
...
namespace NetworkMessages.FromServer
{
  ...
  public sealed class KickPlayerPoll : GameNetworkMessage
  {
    ...
    protected override string OnGetLogFormat() => "Start poll to kick" + (this.BanPlayer ? " and ban" : "") + " player: " + this.PlayerPeer.UserName;
  }
}
