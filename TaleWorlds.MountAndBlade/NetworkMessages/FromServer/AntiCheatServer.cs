...
// Type: NetworkMessages.FromServer.AntiCheatServer
...
namespace NetworkMessages.FromServer
{
  ...
  public sealed class AntiCheatServer : GameNetworkMessage
  {
    public byte[] Data { get; private set; }

    public AntiCheatServer(byte[] data) => this.Data = data;
    ...
    protected override string OnGetLogFormat() => "Receiving Anti Cheat Server message";
  }
}
