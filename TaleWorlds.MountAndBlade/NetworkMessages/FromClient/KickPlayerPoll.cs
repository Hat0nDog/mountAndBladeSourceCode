...
// Type: NetworkMessages.FromClient.KickPlayerPoll
...
namespace NetworkMessages.FromClient
{
  ...
  public sealed class KickPlayerPoll : GameNetworkMessage
  {
    ...
    protected override string OnGetLogFormat() => "Requested to start poll to kick" + (this.BanPlayer ? " and ban" : "") + " player: " + this.PlayerPeer.UserName;
  }
}
