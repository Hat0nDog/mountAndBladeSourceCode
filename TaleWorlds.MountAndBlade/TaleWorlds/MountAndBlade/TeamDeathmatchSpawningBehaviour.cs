...
// Type: TaleWorlds.MountAndBlade.TeamDeathmatchSpawningBehaviour
...
{
  internal class TeamDeathmatchSpawningBehaviour : SpawningBehaviourBase
  {
    private Timer _spawnCheckTimer;

    public TeamDeathmatchSpawningBehaviour()
    {
